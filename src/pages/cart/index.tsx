                ...
                <div className=" flex flex-col gap-5">
                    ...
                    <div className="w-full flex items-center gap-5">
                      ...
                      border-y border-solid border-white border-t-transparent shadow-md"
                        ...
                        <div onClick={() => router.push(`/checkout/${item?.product?._id}`)} className="px-4 cursor-pointer py-1 rounded-md bg-yellow-400 text-white font-medium text-sm">Buy Bow</div>
                    </div>
                </div>
            </div>
        </article>
        ...
        <div className="w-full h-fit flex  items-center gap-5 rounded-md bg-white shadow-[rgba(17,_17,_26,_0.1)_0px_0px_16px] p-5">
            ...
            <div className="w-full flex items-start flex-col gap-2">
                ...
                <div className="w-full flex items-center justify-between">
                    ...
                    <div onClick={() => router.push(`/checkout/${item?.product?._id}`)} className="px-4 py-1 cursor-pointer rounded-md bg-yellow-400 text-white font-medium text-sm">Buy Bow</div>
                </div>
            </div>
