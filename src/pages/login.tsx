                        ...
                        {({ errors, touched }) => (
                            <Form className='bg-white rounded-2xl shadow-[0px_0px_4px_1px_#00000024] w-full h-full flex flex-col justify-between gap-5 md:p-10 p-5'>
                                ...
                                <div className='flex flex-col gap-1'>
                                    ...
                                    <Link href="/register" className='md:text-sm text-xs text-gray-500 font-normal'>{`Start your website in seconds. Don’t have an account?`} <span className=' text-blue-500 md:text-base text-sm cursor-pointer'> Sign Up</span>. </Link>
                                </div>
                                ...
                                <div className='w-full flex md:flex-row flex-col gap-2 items-center justify-between'>
                                    <Link href="/" className='text-sm md:w-fit w-full flex items-center justify-center font-medium text-green-600 px-5 py-2 bg-green-50 hover:bg-green-200 duration-150  rounded-lg cursor-pointer'>Back To Home</Link>
                                    <p className='text-blue-500 md:w-fit w-full flex items-center justify-center px-5 py-2 bg-blue-50 text-sm hover:bg-blue-200 duration-150 rounded-lg font-normal cursor-pointer'>Forgot password?</p>
                                </div>
