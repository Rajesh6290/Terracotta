                ...
                render: (item) => (
                  <div className="flex items-center justify-center gap-5">
                    <p onClick={() => {
                      setValue(item)
                      setEditOpen(true)
                    }} className="text-2xl cursor-pointer text-gray-900 "><BiEdit /></p>
                    <p onClick={() => deleteOperation(item?.id)} className="text-2xl text-red-500  cursor-pointer"><MdOutlineDelete /></p>
                  </div>
                )
              },
            ]}
